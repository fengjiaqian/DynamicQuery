...
define(['app', 'directives/biz-Select',
    ...
    'services/ErrorBoxCodeService'
], function (app) {
    app.controller('ErrorBoxCodeListController', ['$http', '$scope', '$filter', '$rootScope', '$state', 'ejpJiupiCityService', 'EarningReportService', 'ErrorBoxCodeService', 'popupWinService', 'QueryDataService', 'BizSelectService', 'CommonService', 'pagedataLoading',
        function ($http, $scope, $filter, $rootScope, $state, ejpJiupiCityService, EarningReportService, ErrorBoxCodeService, popupWinService, QueryDataService, BizSelectService, CommonService, pagedataLoading) {
            ...
            $scope.query = function () {
                ...
                $scope.vm.items = {};
                pagedataLoading.loading();
                ErrorBoxCodeService.listErrorBoxCode($scope.vo).then(function (response) {
                    pagedataLoading.unloading();
                    if (response.success == true) {
