...
define(['app', 'directives/biz-Select', 
    ...
    app.controller('StoreKeeperEarningReportController', ['$http','$scope','$filter', '$rootScope', '$state','EarningReportService','popupWinService','QueryDataService', 'BizSelectService', 'CommonService','ExcelFileDownLoad','pagedataLoading',
        function ($http,$scope,$filter, $rootScope, $state,EarningReportService,popupWinService, QueryDataService, BizSelectService,  CommonService,ExcelFileDownLoad,pagedataLoading) {
           ...
           //查询
            ...
            $scope.query = function () {
                ...
                $scope.vm.items={};
                EarningReportService.getStoreKeeperReport($scope.vo).then(function (response) {
            ...
            $scope.exportExcel = function () {
                ...
                ExcelFileDownLoad.downLoad("/templates/storeKeeperEarningReport/downloadExcel",$scope.vo,"仓管业绩报表");
            };
