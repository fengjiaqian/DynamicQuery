...
define(['app', 'directives/biz-Select', 
    ...
    app.controller('DriverEarningReportController', ['$http','$scope','$filter', '$rootScope', '$state','EarningReportService','popupWinService','QueryDataService', 'BizSelectService', 'CommonService','ExcelFileDownLoad','pagedataLoading',
        function ($http,$scope,$filter, $rootScope, $state,EarningReportService,popupWinService, QueryDataService, BizSelectService,  CommonService,ExcelFileDownLoad,pagedataLoading) {
           ...
           //查询
            ...
            $scope.query = function () {
                ...
                $scope.vm.items={};
                EarningReportService.getDriverReport($scope.vo).then(function (response) {
            ...
            $scope.exportExcel = function () {
                ...
                ExcelFileDownLoad.downLoad("/templates/CalcMotormanReport/downloadExcel",$scope.vo,"司机业绩报表");
            };
