(function (window) {
  ...
  function getRandomImg() {
    return 'https://picsum.photos/360/100/?image=' + getRandomNumberByRange(0, 100)
  }
  ...
  class jigsaw {
    ...
    initDOM() {
      ...
      const sliderArrow = createElement('div')
      ...
      sliderArrow.className = 'sliderArrow'
      ...
      sliderArrow.appendChild(sliderIcon)
      sliderMask.appendChild(sliderArrow)
    ...
    bindEvents() {
      ...
      this.sliderArrow.addEventListener('mousedown', function (e) {
      ...
      document.addEventListener('mousemove', (e) => {
        ...
        this.sliderArrow.style.left = moveX + 'px'
